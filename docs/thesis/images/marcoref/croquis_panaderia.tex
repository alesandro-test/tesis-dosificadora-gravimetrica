...
% Hoja y giro de la puerta propuestos para revisión; no son un dato de campo.
\begin{tikzpicture}[
    font=\small,
...
\draw[fill=black!5, line width=0.6pt] (11.4,0.2) rectangle (13.7,3.9);
...
% Cotas transcritas del original; no se identifican como recorrido medido.
