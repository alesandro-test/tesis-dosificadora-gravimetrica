...
La Figura~\ref{fig:proceso_general_pan} presenta las etapas generales de
elaboración del pan. En la preparación se reúnen los ingredientes requeridos
para la elaboración. La dosificación establece la cantidad de cada ingrediente
que ingresa al proceso. Durante el mezclado y amasado, los ingredientes se
integran para formar la masa. Luego, la masa se divide y se forma según el
producto elaborado. Posteriormente se realiza la fermentación y, finalmente,
la cocción. El recuadro de líneas discontinuas delimita la dosificación de
ingredientes y destaca la harina como la materia prima comprendida en el
proyecto.
...
El proyecto aplica la integración de diseño mecánico, medición
gravimétrica, electrónica y control a la dosificación de harina en la
Panadería San Miguel. Esta integración permite plantear el control
automático de la alimentación a partir de una cantidad objetivo y del
pesaje de la harina dosificada, funciones que en el procedimiento actual
requieren la intervención del operario.

El aporte propuesto consiste en desarrollar y evaluar esta integración
en un prototipo para el caso de estudio. Su comparación con el
procedimiento manual considera el tiempo de dosificación, la intervención
del operario, la diferencia respecto de la cantidad objetivo y la
repetibilidad. Esta evaluación permite determinar si la automatización
propuesta aporta mejoras bajo las condiciones de operación estudiadas.
...
registrado requiere su intervención en la preparación del pesaje, las
cargas y los traslados, así como en el ajuste y la comprobación final.
La automatización propuesta busca reducir la intervención necesaria
durante la alimentación y el pesaje, con la expectativa de disponer de
tiempo para otras actividades del establecimiento.

Este beneficio esperado se limita al caso de estudio y requiere
comprobación mediante la comparación experimental con el procedimiento
manual. Los registros actuales no permiten afirmar mejoras en salud
ocupacional, empleo o calidad de vida.
...
seleccionó por su principio gravimétrico y control automático, mientras que
Trust-Long se incluyó por su operación por lotes de harina. La
...
La comparación del costo documentado del prototipo con estas referencias,
junto con sus diferencias funcionales y técnicas, establece el criterio para
evaluar la condición de bajo costo.
...
\begin{itemize}
    ...
    % Exclusión solicitada por el autor; susceptible de revisión posterior.
