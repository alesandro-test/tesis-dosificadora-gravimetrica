...
El aporte tecnológico integra diseño mecánico, medición
gravimétrica, electrónica y control en un prototipo automatizado para la
dosificación de harina. El sistema controla la alimentación a partir de una
cantidad objetivo y de la medición de la harina dosificada. Su desempeño se
evalúa frente al procedimiento manual mediante el tiempo de dosificación,
la intervención del operario, la diferencia respecto de la cantidad objetivo
y la repetibilidad.
